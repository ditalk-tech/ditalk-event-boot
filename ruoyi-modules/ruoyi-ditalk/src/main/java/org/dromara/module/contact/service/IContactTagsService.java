 ...
 * @date 2025-06-11
 */
public interface IContactTagsService {
    ...
    ContactTagsVo queryById(Long id);
     ...
     * @return 联系人标签分页列表
     */
    TableDataInfo<ContactTagsVo> queryPageList(ContactTagsBo bo, PageQuery pageQuery);
     ...
     * @return 联系人标签列表
     */
    List<ContactTagsVo> queryList(ContactTagsBo bo);
     ...
     * @return 是否新增成功
     */
    Boolean insertByBo(ContactTagsBo bo);
    ...
    Boolean updateByBo(ContactTagsBo bo);
     ...
     * @return 配置信息列表
     */
    List<ContactTagsVo> queryList(ContactTagsBo bo, IdPageQuery pageQuery);
}
